...
public class AffineTransform implements Cloneable, java.io.Serializable {
    ...
    public Point transform(Point ptSrc, Point ptDst) {
        ...
        default:
            ...
            /* NOTREACHED */
        case (APPLY_SHEAR | APPLY_SCALE | APPLY_TRANSLATE):
            ptDst.set((int)(x * m00 + y * m01 + m02),
                    (int)(x * m10 + y * m11 + m12));
            return ptDst;
        case (APPLY_SHEAR | APPLY_SCALE):
            ptDst.set((int)(x * m00 + y * m01), (int)(x * m10 + y * m11));
            return ptDst;
        case (APPLY_SHEAR | APPLY_TRANSLATE):
            ptDst.set((int)(y * m01 + m02), (int)(x * m10 + m12));
            return ptDst;
        case (APPLY_SHEAR):
            ptDst.set((int)(y * m01), (int)(x * m10));
            return ptDst;
        case (APPLY_SCALE | APPLY_TRANSLATE):
            ptDst.set((int)(x * m00 + m02), (int)(y * m11 + m12));
            return ptDst;
        case (APPLY_SCALE):
            ptDst.set((int)(x * m00), (int)(y * m11));
            return ptDst;
        case (APPLY_TRANSLATE):
            ptDst.set((int)(x + m02), (int)(y + m12));
            return ptDst;
        case (APPLY_IDENTITY):
            ptDst.set((int)(x), (int)(y));
            return ptDst;
        }
    ...
    public void transform(Point[] ptSrc, int srcOff,
        ...
        while (--numPts >= 0) {
            ...
            default:
                ...
                /* NOTREACHED */
            case (APPLY_SHEAR | APPLY_SCALE | APPLY_TRANSLATE):
                dst.set((int)(x * m00 + y * m01 + m02),
                            (int)(x * m10 + y * m11 + m12));
                break;
            case (APPLY_SHEAR | APPLY_SCALE):
                dst.set((int)(x * m00 + y * m01), (int)(x * m10 + y * m11));
                break;
            case (APPLY_SHEAR | APPLY_TRANSLATE):
                dst.set((int)(y * m01 + m02), (int)(x * m10 + m12));
                break;
            case (APPLY_SHEAR):
                dst.set((int)(y * m01),(int)( x * m10));
                break;
            case (APPLY_SCALE | APPLY_TRANSLATE):
                dst.set((int)(x * m00 + m02), (int)(y * m11 + m12));
                break;
            case (APPLY_SCALE):
                dst.set((int)(x * m00), (int)(y * m11));
                break;
            case (APPLY_TRANSLATE):
                dst.set((int)(x + m02), (int)(y + m12));
                break;
            case (APPLY_IDENTITY):
                dst.set((int)(x), (int)(y));
                break;
